										...
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="profile.php" class="avatar" style="width:40px;height:40px;"><img alt="picture" src="assets/img/profiles/<?php echo htmlentities($row->Picture);?>" style="width:40px;height:40px;"></a>
