			...
			<div class="account-content">
				<div class="container">
					...
					<div class="account-logo">
						<a href="index.php"><img src="assets/img/logo-nozom-icon.png" alt="Company Logo"></a>
					</div>
					<!-- /Account Logo -->
						...
						<div class="account-wrapper">
							...
							<form method="POST" enctype="multipart/form-data">
								...
								<div class="form-group text-center">
									<button class="btn btn-info" style="width:100%; height:50px;" name="login" type="submit">Login</button>
										<div class="col-auto pt-2">
											<a class="text-muted float-left" href="forgot-password.php">
												Forgot password?
											</a>
										</div>
								</div>
