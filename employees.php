					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto float-right ml-auto">
								<a href="#" class="btn btn-info" style="margin-left:10px;margin-right:10px;" data-toggle="modal" data-target="#add_employee"><i class="fa fa-plus"></i> Add Employee</a>
							...
							<div class="form-group form-focus select-focus">
								<select class="select floating"> 
									...
									<?php
										...
										{
									?>
									<option value="<?php echo htmlentities($row1->Designation); ?>" style="color:black;"><?php echo htmlentities($row1->Designation); ?></option>
                                        <?php
                                        }
                                        }
                                        ?>
						...
						<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget">
								<div class="profile-img">
									<a href="profile.html" class="avatar" ><img src="assets/img/profiles/<?php echo htmlentities($row->Picture); ?>" style="width:80px;height:80px;" alt="picture"></a>
								</div>
