                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								<a href="#"  class="noti-dot"><i class="la la-dashboard"></i> <span> Dashboard</span> <span class="menu-arrow"></span></a>
							...
							<li class="submenu">
								...
								<li><a href="#clients.php"> <span>Project Managers</span></a><li>
								</ul>
							</li>
							<li class="menu-title"> 
								<span>Projects</span>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a href="project_type.php">Project Type</a></li>
									<li><a href="projects.php">Projects</a></li>
									<li><a href="#projects.php">Public Files</a></li>
								</ul>
							</li>
							<!-- <li> 
							...
							<li class="" style="margin-top:25px;"> 
